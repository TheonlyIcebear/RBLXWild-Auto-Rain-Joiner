...
Then get your cloudflare cookie by going to [rblxwild](https:\\rblxwild.com) in firefox

Then open the devoloper tab by pressing f12, and on any of the requests that have rblxwild.com as the host name scroll down the headers, and copy the cookie headers<br>
